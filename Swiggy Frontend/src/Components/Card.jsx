...
const Card = (props) => {
  return (
    <div className='w-62.5 my-3 shrink-0 cursor-pointer'>
      ...
      <img className='group-hover:scale-110 transition-transform duration-300 w-full h-full' src={`https://swiggy-production-d608.up.railway.app/images/${props.image}`} alt="" /> 
